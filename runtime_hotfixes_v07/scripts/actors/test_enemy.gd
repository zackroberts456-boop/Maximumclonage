...
func _ready():
    ...
    # Stable archive art is used for the v0.7 APK while the larger production sheet
    # is transported through a safer asset pipeline. Gameplay AI/collision remains
    # identical to the production pass, avoiding any movement/balance regression.
    sprite = Sprite2D.new()
